...
import { saveFeedbcak } from '../fn/feedback/save-feedbcak';
import { SaveFeedbcak$Params } from '../fn/feedback/save-feedbcak';
...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `saveFeedbcak()` */
  static readonly SaveFeedbcakPath = '/feedbacks';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `saveFeedbcak()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveFeedbcak$Response(params: SaveFeedbcak$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return saveFeedbcak(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `saveFeedbcak$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveFeedbcak(params: SaveFeedbcak$Params, context?: HttpContext): Observable<number> {
    return this.saveFeedbcak$Response(params, context).pipe(
